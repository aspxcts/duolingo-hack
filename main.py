...
listenforword = ("Listen for the missing word")
...
mon = {'left': 632, 'top': 346, 'width': 600, 'height': 100}
        ...
        while True:
            ...
            while index < len(result):
                ...
                if selectpairkeys in result:
                    ...
                    listenandhear()
                if listenforword in result:
                    print("found phrase: listenforword ", listenforword)
                    listenandhear()
                else:
